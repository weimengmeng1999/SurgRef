...
def add_keyframe_selector_config(cfg):
    cfg.MODEL.KEYFRAME_SELECTOR = CN()
    cfg.MODEL.KEYFRAME_SELECTOR.ENABLED = False
    cfg.MODEL.KEYFRAME_SELECTOR.QUERY_DIM = 256
    cfg.MODEL.KEYFRAME_SELECTOR.HIDDEN_DIM = 128
    cfg.MODEL.KEYFRAME_SELECTOR.TOP_K_RATIO = 0.5
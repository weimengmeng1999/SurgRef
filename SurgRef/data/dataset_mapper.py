...
class MeViSDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        for frame_idx in selected_idx:
            ...
            # print(f"Image after augmentation shape: {aug_input.shape}")
        ...
        # dataset_dict['lang_tokens'] = torch.tensor(padded_input_ids)
        # dataset_dict['lang_mask'] = torch.tensor(attention_mask)
